...
1. **Frontend:** A hand-rolled Lexer and Recursive Descent Parser that construct an Abstract Syntax Tree (AST), followed by semantic analysis for type and scope checking.
...
- [ ] **Renamer:** Name resolution (Scope Renamer) pass.
